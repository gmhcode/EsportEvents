...
//    var everyTourny :[Date:[UpcomingTourny]]? {
//        didSet{
...
//    func triggerEveryTourn(completion: @escaping (Bool?)->Void) -> Bool?{
//
//        if let allTournaments = SourceOfTruth.shared.everyTournament{
//            everyTourny = allTournaments
//
//            completion(true)
//            return true
//        }
//        else {
//            triggerEveryTourn { (_) in
//
//            }
//        }
//        completion(nil)
