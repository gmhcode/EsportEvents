...
//"2017-12-07T00:00:00Z
    ...
    func configureCalendar(_ calendar: JTAppleCalendarView) -> ConfigurationParameters {
        ...
        let parameters = ConfigurationParameters(startDate: Date(), endDate: eDate, numberOfRows: 5, calendar: Calendar.current, generateInDates: .forAllMonths, generateOutDates: .tillEndOfRow, firstDayOfWeek: .monday)
        return parameters
